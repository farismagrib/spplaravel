...
@section('konten')
    <div class="container-fluid">
        ...
        <div class="text-center">
            ...
            <p class="mb-4">"Sedikit kemajuan setiap hari menambah hasil yang besar!"</p>
        </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                                    ...
                                    <td>
                                        <form action="{{ route('pembayaran.delete', $row->id) }}" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-danger"
                                                onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"><i class="fas fa-eraser">Hapus</button></i>
                                        </form>
                                    </td>
                                    <td>
                                        <a href="#" class="btn btn-sm btn-warning" data-toggle="modal"
                                            data-target="#editModal{{ $row->id }}"><i class="fas fa-pen">EDIT</a></i>
                                    </td>
                                </tr>
                    ...
                    <button class="btn btn-sm btn-primary btn-block" data-toggle="modal" data-target="#tambahData"><i class="fas fa-plus">Tambah Data</button></i>
                    <a href="/excel-export"><button type="button" class="btn btn-sm btn-success btn-block" onclick="return confirm('apakah anda mau mengimport ini?')"><i class="fas fa-file-excel">Import Excel</button></a></i>
                </div>
            </div>
        </div>
    </div>
